...
(function(window, undefined) {
    ...
    //         "class": "className",
        ...
        getEmDimensions: function(elem) {
            ...
            for (var i=0; i <= 63; i++) {
                fillerX += "\u2588"; // Fill it with a single character (this is a unicode "full block": 鈻�).  Using the \u syntax because minifiers don't seem to like unicode characters to be in the source as-is.
            }
            for (var i=0; i <= 63; i++) {
        ...
        emulateKeyCombo: function(e) {
            ...
            if (!modifiers.alt && !modifiers.ctrl && modifiers.meta) {
                if (goIn.keyTable[key.string]) {
                    ...
                    // Macs need this to support pasting with 鈱�-v (鈱�-c doesn't need anything special)
